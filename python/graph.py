...
class Graph:
    ...
    :argument __graph_data: defaultdict: dictionary with nodes as keys and list of adjacent nodes as value
    ...
    def draw(self, show_plot: bool = True, node_colors: list = None) -> None:
        ...
        :param show_plot: optional, bool, default = True
                         defines whether to show or not graph as networkx plot;
        :param node_colors: array-like, optional, default = None
